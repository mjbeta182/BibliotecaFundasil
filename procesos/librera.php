...
function mostrarDatos($bdConexion)
{
	...
	while($fila = mysqli_fetch_array($rsMostrar))
	{
		print "<tbody>
				...
				<a href='frmLibrera.php?accion=update&hCodigo=".$fila['idLibrera']."&txtNombre=".$fila['nombreLibrera']."'>
                                    <button type='submit' class='btn btn-warning boton' id='btnEditar'>Editar</button>
				</a>
				<a href='tblLibrera.php?accion=delete&hCodigo=".$fila['idLibrera']."&txtNombre=".$fila['nombreLibrera']."' onclick='return confirmDelete();'>
