	...
	while($fila = mysqli_fetch_array($rsMostrar))
	{
		print "<tbody>
				...
				<td style='text-align: center;'>
					<a href='frmBiblioteca.php?accion=update&hCodigo=".$fila['idBiblioteca']."&txtNombre=".$fila['nombreBiblioteca']."'>
					<button type='submit' class='btn btn-warning boton' id='btnEditar'>Editar</button>
					</a>
					<a href='tblBiblioteca.php?accion=delete&hCodigo=".$fila['idBiblioteca']."&txtNombre=".$fila['nombreBiblioteca']."' onclick='return confirmDelete();'>
