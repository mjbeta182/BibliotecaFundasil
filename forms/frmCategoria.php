    ...
    <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 form-wrap">
        <form  action="#" method="GET">
            <div class="input-group">
                ...
                <input type="text" class="form-control" id="hCodigo"        value="<?=$hCodigo?>"       placeholder="Codigo"    readonly="" >
                <input type="text" class="form-control" id="txtCategoria"   value="<?=$txtCategoria?>"  placeholder="Nombre"    required="true" >
            </div>
            <br>
            <br>
