...
<div class="row3">
    ...
    <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 form-wrap">
        <form  action="tblLibrera.php" method="GET">
            ...
            <a href="tblLibrera.php" id="btnCancelar" class="btn btn-warning">Cancelar</a>
